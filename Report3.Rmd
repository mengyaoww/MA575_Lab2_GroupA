...
Full_model2 <- lm(price ~ mileage + engine_power + model_series + I(mileage^2), data = dat_bmw_clean)
summary(Full_model2)
...
```{r}
Full_model3 <- lm(price ~ mileage + engine_power + model_series + I(mileage^2) + mileage:engine_power, data = dat_bmw_clean)
summary(Full_model3)
...
Full_model3_train <- lm(price ~ mileage + engine_power + model_series + I(mileage^2) + mileage:engine_power, data = dat_train)
