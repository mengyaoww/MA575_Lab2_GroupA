...
X <- model.matrix(price ~ mileage + engine_power + model_series + age + mileage:engine_power, data = dat_bmw_train)[, -1]
...
newX <- model.matrix(price ~ mileage + engine_power + model_series + age + mileage:engine_power, data = validation_data)[, -1]
